 ...
 */
static const char *fonts[]     = {"Source Code Pro:weight=bold:size=13:antialias=true:hinting=true",
                                  "Ubuntu:size=13:antialias=true:autohint=true",
                                  "JoyPixels:size=14:antialias=true:autohint=true"};
//other great fonts
//DejaVuSansMono


static const char col_1[]  = "#2f4f4f"; /* background color of bar */
static const char col_2[]  = "#8b0000"; /* border color unfocused windows */
static const char col_3[]  = "#82b48c"; /* icon colors */
...
static const char *emojicmd[]  = { "emojicherrypick", "-c","--menu", "dmenu", NULL };
static const char *wintogglecmd[]  = { "rdpwin", "-s", NULL };
static const char *windiscmd[]  = { "rdpwin", "-d", NULL };

static Keychord keychords[] = {
	/* Keys        function        argument */
	{1, {{MODKEY, XK_m}}, spawn,          {.v = dmenucmd } },
	{1, {{MODKEY, XK_Return}},			 spawn,          {.v = termcmd } },
	{1, {{MODKEY|ShiftMask, XK_f}},			 spawn,          {.v = filecmd } },
	{1, {{Mod1Mask, XK_Return}},         spawn,          {.v = tabtermcmd } },
	{1, {{MODKEY, XK_e}}, spawn,          {.v = emojicmd } },
	{1, {{MODKEY|ShiftMask, XK_w}}, spawn,          {.v = wintogglecmd } },
	{1, {{MODKEY, XK_w}}, spawn,          {.v = windiscmd } },
    ...
    /* Web browsers */
    {1, {{MODKEY, XK_q}},                 spawn,         SHCMD("qutebrowser") },
