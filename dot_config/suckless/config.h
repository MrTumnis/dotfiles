...
static char titlenormfgcolor[]           = "#589072"; 
static char titlenormbgcolor[]           = "#000000";
static char titlenormbordercolor[]       = "#000000";
static char titlenormfloatcolor[]        = "#ffffff";

static char titleselfgcolor[]            = "#005577";
static char titleselbgcolor[]            = "#000000";
static char titleselbordercolor[]        = "#000000";
static char titleselfloatcolor[]         = "#000000";

static char tagsnormfgcolor[]            = "#4c889f";   //tags color
static char tagsnormbgcolor[]            = "#000000";   //black border around tags
static char tagsnormbordercolor[]        = "#000000";   
static char tagsnormfloatcolor[]         = "#ffd700";   //gold

static char tagsselfgcolor[]             = "#998100";   //Change the colors of the tags 
static char tagsselbgcolor[]             = "#000000";                                          //10713c green
 ...
 *    { "Gimp",     NULL,     NULL,  NULL,    1 << 2,    0,          -1 },     ////////Changed the tag mask from 1<<4
 *    { "$BROWSER",  NULL,     NULL,  NULL,    1 << 3,    0,          -1 },     ////////Changed the tag mask from 1<<7
 *
 * The RULE macro has the default values set for each field allowing you to only
 * specify the values that are relevant for your rule, e.g.
 *
 *    RULE(.class = "Gimp", .tags = 1 << 2)      /////////////////////////////////////
 *    RULE(.class = "$BROWSER", .tags = 1 << 3)  /////////////////////////////////////
 *
