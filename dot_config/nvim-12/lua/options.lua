...
o.winborder     = "rounded"    -- new in 0.11; used by vim.lsp hover, Mason UI, etc.
o.completeopt   = { "menu", "menuone", "noselect", "popup" }

-- taken from radleylewis
local undodir = vim.fn.expand("~/.local/share/nvim-12/undodir")
if
...
o.guicursor =
	"n-v-c:block,i-ci-ve:block,r-cr:hor20,o:hor50,a:blinkwait650-blinkoff400-blinkon250-Cursor/lCursor,sm:block-blinkwait175-blinkoff150-blinkon175"
